...
function focusableChildren(el) {
  ...
  return [...el.querySelectorAll(targets)].filter((x) => !x.closest("[inert]")).filter((x) => !!x.offsetParent || x.getClientRects().length > 0).filter((x) => {
    var _a, _b;
...
//# sourceMappingURL=chunk-Y73U7KBF.js.map
