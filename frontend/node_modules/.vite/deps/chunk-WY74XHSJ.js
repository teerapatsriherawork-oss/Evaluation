...
function createDateRange(adapter, start, stop) {
  const diff = adapter.getDiff(/* @__PURE__ */ new Date(`${adapter.toISO(stop ?? start)}T00:00:00Z`), /* @__PURE__ */ new Date(`${adapter.toISO(start)}T00:00:00Z`), "days");
...
//# sourceMappingURL=chunk-WY74XHSJ.js.map
